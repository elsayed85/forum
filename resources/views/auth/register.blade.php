                    ...
                    <form class="form-default" action="{{ route('register') }}" method="POST">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="email" class="form-control @error('email') is-invalid @enderror"
                                id="loginEmail" placeholder="Email here">
                            @error('email')
                            <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
                            </span>
                        ...
                        <div class="form-group">
                            ...
                            <input type="password" name="password"
                                class="form-control @error('password') is-invalid @enderror" id="loginUserPassword"
                                placeholder="************">
                        </div>
                        <div class="row">
                        ...
                        <div class="row">
                            ...
                            <div class="col">
                                <div class="form-group">
                                    <a href="{{ route('social.login' , 'google') }}" class="btn btn-color02 btn-block">
                                        <i>
                                            <svg class="icon">
                        ...
                        <p>Already have an account? <a href="{{ route('login') }}" class="tt-underline">Create my
                                account</a></p>
                        <div class="tt-notes">
